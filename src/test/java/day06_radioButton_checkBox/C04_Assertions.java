...
public class C04_Assertions {
    ...
    @Test
    public void test01(){
//Eger test methodunda hicbir test yoksa,test calistiktan sonra hicbir problemle karsilasilmadigini raporlamak icin tests passed yazisi cikar.
//Eger testleri if() ile yaparsak test FAILED olsa bile, kodlar problemsiz calistigi icin kod calismasi bittiginde ekranin sol alt kisminda TEST PASSED yaxacaktir.
